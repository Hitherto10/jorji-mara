...
export const CurrencySelector = ({ mobile, light }) => {
    ...
    return (
        <select
            ...
            className={`bg-transparent outline-none cursor-pointer transition-colors ${
                mobile ? 'w-full py-3 px-4 rounded-sm text-sm border border-stone-200 text-stone-900 hover:border-stone-400' 
                : light ? 'text-xs py-1 px-2 rounded-sm border border-white/30 text-white hover:border-white' 
                : 'text-xs py-1 px-2 rounded-sm border border-stone-200 text-stone-900 hover:border-stone-400'
            }`}
        >
